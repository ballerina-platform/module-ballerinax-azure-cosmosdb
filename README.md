...
- Ballerina SL Beta 1 installed. <br/>
...
[Sample](cosmosdb/samples/data-operations/documents/replace_document.bal)
...
[Sample](cosmosdb/samples/data-operations/documents/get_document.bal)
...
[Sample](cosmosdb/samples/data-operations/documents/list_documents.bal)
...
[Sample](cosmosdb/samples/data-operations/documents/delete_document.bal)
...
[Sample](cosmosdb/samples/data-operations/documents/query_document.bal)
...
[Sample](cosmosdb/samples/data-operations/stored-procedure/create_stored_procedure.bal)
...
```
[Sample](cosmosdb/samples/data-operations/stored-procedure/replace_stored_procedure.bal)
...
```
[Sample](cosmosdb/samples/data-operations/stored-procedure/list_stored_procedure.bal)
...
```
[Sample](cosmosdb/samples/data-operations/stored-procedure/delete_stored_procedure.bal)
...
[Sample](cosmosdb/samples/data-operations/stored-procedure/execute_stored_procedure.bal)
...
[Sample](cosmosdb/samples/admin-operations/database/create_database.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/database/get_a_database.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/database/list_databases.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/database/delete_database.bal)
...
[Sample](cosmosdb/samples/admin-operations/container/create_container.bal)
### Get a container
...
```
[Sample](cosmosdb/samples/admin-operations/container/get_container.bal)
...
[Sample](cosmosdb/samples/admin-operations/container/list_containers.bal)
...
[Sample](cosmosdb/samples/admin-operations/container/delete_container.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/user-defined-functions/create_udf.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/user-defined-functions/replace_udf.bal)
...
[Sample](cosmosdb/samples/admin-operations/user-defined-functions/list_udf.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/user-defined-functions/delete_udf.bal)
...
[Sample](cosmosdb/samples/admin-operations/triggers/create_trigger.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/triggers/replace_trigger.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/triggers/list_trigger.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/triggers/delete_trigger.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/user/create_user.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/user/replace_user_id.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/user/get_user.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/user/list_users.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/user/delete_user.bal)
...
[Sample](cosmosdb/samples/admin-operations/users-permissions/permission/create_permission.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/permission/replace_permission.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/permission/get_permission.bal)
...
```
[Sample](cosmosdb/samples/admin-operations/users-permissions/permission/list_permissions.bal)
...
[Sample](cosmosdb/samples/admin-operations/users-permissions/permission/delete_permission.bal)
...
[Sample](cosmosdb/samples/admin-operations/offers/offer_operations.bal)
